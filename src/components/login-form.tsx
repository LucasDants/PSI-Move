    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6">
        <div className="grid gap-2">
          ...
          <Input id="username" placeholder="Lucas" onChange={e => setUsername(e.target.value)} value={username} required />
          {
            hasError && <p className="text-destructive text-xs">Erro ao encontrar o perfil do Github!</p>
          }
        </div>
        {/* <div className="grid gap-2">
